...
function BasicInfoEdit() {
  return (
    <div className='bg-gray-50 pt-1 pb-0'>
        <h1 className='text-2xl text-left ml-48 mt-24 small:ml-16 medium:ml-24'>Basic Info</h1>
                ...
                <div className="w-3/4		 px-4 py-5 sm:p-6">
                  <div className="grid grid-cols-9 gap-6">
                    ...
                    <div className="col-span-6 sm:col-span-9 ">
                      <label htmlFor="Biography" className="block text-left text-sm font-medium text-gray-700">
                        Biography
                      </label>
                      <textarea 
                        type="text"
