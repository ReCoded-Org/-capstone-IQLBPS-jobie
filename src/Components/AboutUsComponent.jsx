...
<h1 className='font-semibold text-5xl  ml-56 small:ml-8	medium:ml-8 large:ml-8  text-green-600  ' > About <span className="text-secondary  ">Us?</span></h1>
</div>
 ...
 <img className='ml-56 large:ml-36 mx-auto md:w-96 medium:mb-3    small:ml-0	 medium:ml-0 large:ml-0 medium:justify-start'  src='/aboutus.jpg' alt=""/>


<p className='w-3/6 medium:pr-3 text-justify small:justify small:w-fit small:ml-3 small:mr-3	medium:justify medium:w-fit medium:ml-3 medium:mr-3 '>Our Mission is to build a bridge those who need a job and the ones who needs someone to do the job for them
    ...
    there and allowing job seekers to see their open positions.
</p>
