const AboutHero = (props) => {
  ...
  return (
    <div className="bg-gray-500/5 flex justify-around items-center px-32 small:px-14 small:py-5 medium:py-6 medium:px-16 large:py-8 large:px-18 pt-12 pb-10 pl-23 small:flex-col">
      <div className=" p-8 ">
