const AboutHero = (props) => {
  ...
  return (
    <div className=" bg-zinc-100 flex justify-around items-center px-32 small:px-14 small:py-5 medium:py-6 medium:px-16 large:py-8 large:px-18 pt-7 pl-23">
      <div className=" p-8 ">
      ...
      <div className=" p-8 ">
        <img
          className=" h-auto w-500 small:w-200   "
          src={img}
          alt="ChitChat Logo"
        />
      </div>
